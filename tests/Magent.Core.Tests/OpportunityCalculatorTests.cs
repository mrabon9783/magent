...
public sealed class OpportunityCalculatorTests
{
    ...
    {
        var config = new AppConfig(10000043, 60008494, 15, 3m, 4.5m, 2m, 100, 250, null);
        ...
        var result = sut.Calculate(config, characterOrders, marketOrders, volumes, DateTimeOffset.UtcNow);
